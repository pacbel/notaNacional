...
import { buscarUsuarios } from '@/queries/relatorios/usuariosQueries';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const html = gerarHTMLRelatorio(prestadorComLogo, resultado.usuarios, resultado.paginacao, filtros);
    ...
    console.error('Erro ao gerar relatório HTML de usuários:', error);
...
function gerarHTMLRelatorio(prestador: any, usuarios: any[], paginacao: any, filtros: any) {
  ...
  // Gerar linhas da tabela de usuários
...
<body>
  ...
  <div class="resumo">
    ...
    <div class="resumo-item">
      <span class="resumo-label">Total de Usuários:</span>
      <span>${paginacao.total}</span>
    </div>
  </div>
  ` : `
  <div class="sem-registros">
    Nenhum usuu00e1rio encontrado com os filtros aplicados.
  </div>
  `}
