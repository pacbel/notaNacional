...
export default function ServicosContainer({ prestadores }: ServicosContainerProps) {
  ...
  // Filtrar os campos de acordo com o perfil do usuário
  ...
  const handleImprimir = async () => {
    try {
      ...
      const response = await fetch('/api/relatorios/servicos-html', {
        method: 'POST',
        headers: {
